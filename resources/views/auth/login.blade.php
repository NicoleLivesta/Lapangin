...
<div class="row justify-content-center" style="min-height: 75vh; display: flex; align-items: center;">
    <div class="col-10 col-md-4 mx-auto">
        <div class="card shadow-lg border-radius-lg fade-slide-up">
            <div class="card-header bg-gradient-dark text-center py-3">
                ...
                <p class="text-white text-sm mb-0">Masuk ke sistem menggunakan akun Anda</p>
            </div>
            ...
            <div class="card-body px-4">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <button type="submit" class="btn bg-gradient-dark w-100 mb-2">Login</button>
